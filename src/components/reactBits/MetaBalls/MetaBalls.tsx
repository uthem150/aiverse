...
const MetaBalls: React.FC<MetaBallsProps> = ({
  ...
  useEffect(() => {
    ...
    function getCoordinates(clientX: number, clientY: number) {
      ...
      const x = (px / rect.width) * gl.canvas.width;
      const y = (1 - py / rect.height) * gl.canvas.height;
      return { x, y };
    }
