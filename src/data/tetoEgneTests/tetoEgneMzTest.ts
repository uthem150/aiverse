...
export const tetoEgneMzTestData: TetoEgneTestData = {
  id: 'teto-egne-mz-lifestyle-test',
  title: '🔍 MZ력 테스트: 당신의 테토에겐 지수는?',
  description: '디지털 라이프와 가치관을 통해 알아보는 당신의 테스토스테론 & 에스트로겐 성향 분석.',
  questions: [
    {
      id: 'q1',
    ...
    {
      id: 'q19',
      question: '새로운 챌린지나 트렌드가 유행할 때 당신의 행동은?',
      category: 'behavior', // 'digital_life' -> 'behavior'
      options: [
        {
          id: 'q19_a',
          text: '재미있어 보이면 바로 참여하고 인증샷을 남긴다',
          emoji: '🤳',
          scores: { testo: 2, estrogen: 1 },
        },
        {
          id: 'q19_b',
          text: '친구들이 하는 것을 보고 같이 해볼까 고민한다',
          emoji: '🤔',
          scores: { testo: 1, estrogen: 2 },
        },
        {
          id: 'q19_c',
          text: '나와 상관없는 일이라 생각하고 무시한다',
          emoji: ' nonchalant',
          scores: { testo: 3, estrogen: 0 },
        },
        {
          id: 'q19_d',
          text: '유행의 의미나 배경을 분석하며 흥미롭게 지켜본다',
          emoji: ' analyst',
          scores: { testo: 0, estrogen: 3 },
        },
      ],
    ...
    {
      id: 'q20',
      question: 'SNS에 게시물을 올릴 때 당신의 방식은?',
      category: 'behavior', // 'digital_life' -> 'behavior'
      options: [
        {
          id: 'q20_a',
          text: '남들에게 보여지는 모습보다 나의 만족이 더 중요하다',
          emoji: ' self_satisfied',
          scores: { testo: 3, estrogen: 0 },
        },
        {
          id: 'q20_b',
          text: '많은 사람들의 반응을 기대하며 신중하게 올린다',
          emoji: ' eager',
          scores: { testo: 0, estrogen: 3 },
        },
        {
          id: 'q20_c',
          text: '정보 공유나 기록의 목적으로 가끔씩 올린다',
          emoji: ' informative',
          scores: { testo: 2, estrogen: 1 },
        },
        {
          id: 'q20_d',
          text: '친구들과 소통하는 용도로 자주 올린다',
          emoji: ' sociable',
          scores: { testo: 1, estrogen: 2 },
        },
      ],
    ...
    {
      id: 'q21',
      question: '새로운 디지털 기기나 앱이 나오면 당신은?',
      category: 'preference', // 'digital_life' -> 'preference'
      options: [
        {
          id: 'q21_a',
          text: '일단 사용해보고 장단점을 파악한다',
          emoji: ' explorer',
          scores: { testo: 2, estrogen: 1 },
        },
        {
          id: 'q21_b',
          text: '사람들의 후기를 찾아보고 신중하게 접근한다',
          emoji: ' cautious',
          scores: { testo: 1, estrogen: 2 },
        },
        {
          id: 'q21_c',
          text: '내가 필요하다고 생각하면 바로 구매한다',
          emoji: ' decisive',
          scores: { testo: 3, estrogen: 0 },
        },
        {
          id: 'q21_d',
          text: '주변에서 사용하면 따라서 사용해본다',
          emoji: ' follower',
          scores: { testo: 0, estrogen: 3 },
        },
      ],
    ...
    {
      id: 'q22',
      question: '소비할 때 당신의 가장 중요한 기준은?',
      category: 'preference', // 'values_consumption' -> 'preference'
      options: [
        {
          id: 'q22_a',
          text: '제품의 성능과 효율성을 가장 중요하게 생각한다',
          emoji: '💡',
          scores: { testo: 3, estrogen: 0 },
        },
        {
          id: 'q22_b',
          text: '나의 가치관과 맞는 브랜드인지, 친환경적인지 등 윤리적 기준을 본다',
          emoji: '🌳',
          scores: { testo: 0, estrogen: 3 },
        },
        {
          id: 'q22_c',
          text: '가성비와 가심비를 모두 고려하여 합리적으로 소비한다',
          emoji: '💰',
          scores: { testo: 2, estrogen: 1 },
        },
        {
          id: 'q22_d',
          text: '제품 자체보다 구매 과정에서의 경험이나 스토리를 중요하게 생각한다',
          emoji: ' experience',
          scores: { testo: 1, estrogen: 2 },
        },
      ],
    ...
    {
      id: 'q23',
      question: '새로운 경험이나 도전을 앞두고 당신의 생각은?',
      category: 'behavior', // 'values_consumption' -> 'behavior'
      options: [
        {
          id: 'q23_a',
          text: '결과보다는 과정 자체를 즐기며 몰입한다',
          emoji: ' flow',
          scores: { testo: 1, estrogen: 2 },
        },
        {
          id: 'q23_b',
          text: '성공적인 결과를 위해 철저히 준비하고 노력한다',
          emoji: ' prepared',
          scores: { testo: 3, estrogen: 0 },
        },
        {
          id: 'q23_c',
          text: '새로운 것을 배우고 성장할 기회라고 생각한다',
          emoji: ' growth',
          scores: { testo: 2, estrogen: 1 },
        },
        {
          id: 'q23_d',
          text: '함께 할 사람들과의 관계를 중요하게 생각한다',
          emoji: ' together',
          scores: { testo: 0, estrogen: 3 },
        },
      ],
    ...
    {
      id: 'q24',
      question: '워라밸(Work-Life Balance)에 대한 당신의 생각은?',
      category: 'preference', // 'values_consumption' -> 'preference'
      options: [
        {
          id: 'q24_a',
          text: '일의 성과가 가장 중요하며, 필요하다면 개인 시간을 희생할 수 있다',
          emoji: ' work_first',
          scores: { testo: 3, estrogen: 0 },
        },
        {
          id: 'q24_b',
          text: '개인의 행복과 여가 활동이 일만큼 중요하다',
          emoji: ' balance',
          scores: { testo: 0, estrogen: 3 },
        },
        {
          id: 'q24_c',
          text: '일과 삶의 균형을 유지하려 노력하지만, 상황에 따라 유연하게 대처한다',
          emoji: ' flexible',
          scores: { testo: 2, estrogen: 1 },
        },
        {
          id: 'q24_d',
          text: '다양한 경험을 위해 N잡이나 부업을 시도해보고 싶다',
          emoji: ' side_hustle',
          scores: { testo: 1, estrogen: 2 },
        },
      ],
