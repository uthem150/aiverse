...
export const testCategories: TestCategory[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      //   id: 'hand-pose-test',
      //   title: '손동작 인식',
      //   description: 'AI가 손동작을 실시간으로 분석해서 제스처를 인식합니다',
      //   thumbnail: '/images/hand-pose-test.jpg',
      //   category: 'ai-lab',
      //   difficulty: 'medium',
      //   estimatedTime: 4,
      //   isNew: true,
      ...
      // },
      // {
      //   id: 'pose-estimation-test',
      //   title: '전신 포즈 추정',
      //   description: 'AI가 전신 포즈를 실시간으로 분석해서 동작을 추정합니다',
      //   thumbnail: '/images/pose-estimation-test.jpg',
      //   category: 'ai-lab',
      //   difficulty: 'hard',
      //   estimatedTime: 5,
      //   isNew: true,
